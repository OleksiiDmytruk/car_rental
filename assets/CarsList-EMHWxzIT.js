import{j as e,u as r,r as l,c}from"./index-M8a-oDPD.js";const u=s=>s.cars.isLoading,v=s=>s.cars.rentalCars,m=s=>s.favorites.favorites,g=()=>e.jsx("p",{children:"SearchBar"}),p=r.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`).map((i,t)=>e.jsx("div",{children:e.jsx("p",{children:i})},t)),e.jsx("div",{children:e.jsxs("p",{children:["Mileage: ",s.mileage]})}),e.jsx("div",{children:e.jsxs("p",{children:["Price: ",s.rentalPrice]})})]})]}),e.jsx("button",{type:"button",children:"Rental car"})]})})},j=({car:s})=>{const[n,d]=l.useState(!1);return e.jsxs("div",{children:[e.jsx("img",{src:s.img,alt:s.make}),e.jsxs("div",{children:[e.jsxs("p",{children:[s.make," ",e.jsx("span",{children:s.model}),", ",s.year]}),e.jsx("p",{children:s.rentalPrice})]}),e.jsxs("div",{children:[e.jsxs("div",{children:[e.jsx("p",{children:s.address.split(",")[1]}),e.jsx("div",{}),e.jsx("p",{children:s.address.split(",").pop()}),e.jsx("div",{}),e.jsx("p",{children:s.rentalCompany})]}),e.jsxs("div",{children:[e.jsx("p",{children:s.type}),e.jsx("div",{}),e.jsx("p",{children:s.model}),e.jsx("div",{}),e.jsx("p",{children:s.mileage}),e.jsx("div",{}),e.jsx("p",{children:s.accessories[0]})]})]}),e.jsx("button",{type:"button",onClick:()=>d(!0),children:"Learn more"}),n&&c.createPortal(e.jsx(a,{car:s,onClose:()=>d(!1)}),document.body)]})},b=({rentalCars:s})=>e.jsx("ul",{children:s.map(n=>e.jsx("li",{children:e.jsx(j,{car:n})},n.id))});export{b as C,g as S,v as a,m as b,u as s};
